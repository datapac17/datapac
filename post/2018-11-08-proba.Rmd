...
slug: 
categories: ["benestar"]
tags: ["demografía","defuncións"]
---

```{r setup, include = FALSE}
knitr::opts_chunk$set(comment = NA,echo=F, tidy = FALSE, warning = FALSE, message = FALSE)
```


Os datos que serán usados nos seguintes puntos foron extraídos do [ige](https://www.ige.eu/web/index.jsp?paxina=001&idioma=gl). Nesta entrada trataranse diversos temas: defuncións, nacementos, migracións, avellentamento e poboación segundo o sexo.
...
barplot_interactivo <- ggplotly(p1,width=800,height = 560) %>% 
...
scatter_animado <- ggplotly(p2,width=1100,height = 560) %>% 
